    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ backgroundColor: '#0C1844' }}>
        ...
        <Toolbar >
          ...
          <Button  sx={{ order: 1 }} variant="text" color="inherit">My Projects</Button>
          <Button  sx={{ order: 2 }} variant="text" color="inherit">Progress Tracking</Button>
          <Button  sx={{ order: 3 }} variant="text" color="inherit">Collaboration </Button>
          ...
          {!user && <Button component={Link} to="./pages/Login" color="inherit">Login</Button>}
          {user && (
